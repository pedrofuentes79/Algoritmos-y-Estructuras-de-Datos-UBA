...
public class SistemaCNE {
    ...
    public SistemaCNE(String[] nombresDistritos, int[] diputadosPorDistrito, String[] nombresPartidos, int[] ultimasMesasDistritos) {
        ...
        this.P = len(nombresPartidos);
        this.D = len(nombresDistritos);
        ...
        for (int i=0; i<D; i++){
            this.resultadosPorDistritos[i] = new MaxHeap<NodoDHont>(P);
        }
    }
    ...
    public void registrarMesa(int idMesa, VotosPartido[] actaMesa) {
        ...
        int idDistrito = distritoDeMesa(idMesa);
        ...
        this.resultadosPorDistritos[idDistrito] = new MaxHeap<NodoDHont>(votosDistrito);
    }
    ...
    private boolean auxBallotage(int[] votosPresidenciales) {
        ...
        int max2 = 0;
        int totalVotos = 0;
        for (int i=0; i<len(votosPresidenciales); i++){
