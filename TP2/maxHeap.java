...
public class MaxHeap<Nodo>{
    ...
    public MaxHeap(int[] s){
        // Array2Heap
        this.elementos = (Nodo[]) new NodoDHont[s.length];
        this.longitud = s.length;
        this.posProximo = 0;
    ...
    public void siftDown(int i) {
        ...
        if (right < posProximo && elementos[right].getCocientes() > elementos[largest].getCocientes()) {
            largest = right;
        }
